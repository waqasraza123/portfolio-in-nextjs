    ...
    <section className="relative flex flex-col justify-center items-center mt-16 bg-white text-gray-800 overflow-hidden">
      ...
      <div className="relative z-10 text-center py-16 px-6 max-w-5xl mx-auto">
        ...
        <p className="text-xl md:text-2xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
          I build production-grade apps that don&apos;t break after launch. I
          use Claude + GPT workflows to cut development time (often up to{" "}
          <span className="font-semibold text-gray-800">40%</span>) while
          improving code quality, test coverage and stability. End-to-end:
          product engineering, AI, payments and deployments.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-10">
          <div className="text-center">
            ...
            <div className="text-gray-500 text-sm">Recent Projects</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-gray-900">
              6700+
          ...
          <div className="text-center">
            ...
            <div className="text-gray-500 text-sm">Cost Reduction (case)</div>
          </div>
          <div className="text-center">
